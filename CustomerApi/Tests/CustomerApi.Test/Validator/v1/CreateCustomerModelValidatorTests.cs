...
namespace CustomerApi.Test.Validator.v1
{
    public class CreateCustomerModelValidatorTests
    {
        ...
        {
            _testee.ShouldHaveValidationErrorFor(x => x.FirstName, firstName)
                .WithErrorMessage("The first name must be at least 2 character long");
        }
        ...
        {
            _testee.ShouldHaveValidationErrorFor(x => x.LastName, lastName)
                .WithErrorMessage("The last name must be at least 2 character long");
        }
        ...
        {
            _testee.ShouldHaveValidationErrorFor(x => x.Age, age)
                 .WithErrorMessage("The minimum age is 0 and the maximum age is 150 years");
        }
